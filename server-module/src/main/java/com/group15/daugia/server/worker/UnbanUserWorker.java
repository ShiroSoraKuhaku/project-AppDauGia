...
/**
 * UNBAN-USER: admin bỏ cấm một người dùng.
 *
 ...
 *   { "response": "403 Forbidden" } nếu không phải admin hoặc cố unban admin
 *   { "response": "404 Not Found" } nếu user không tồn tại
 *   { "response": "409 Conflict" } nếu user chưa bị ban
 */
public class UnbanUserWorker implements Workable {
  ...
  public String work(String data) {
    ...
    String result = UserDAO.getUserDao().unbanUser(req.getUsername());
    switch (result) {
      case "OK" -> ans.setResponse("200 OK");
      case "NOT_FOUND" -> ans.setResponse("404 Not Found");
      case "NOT_BANNED" -> ans.setResponse("409 Conflict");
